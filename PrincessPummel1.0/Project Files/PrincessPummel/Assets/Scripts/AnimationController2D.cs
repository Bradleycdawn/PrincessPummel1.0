...
public class AnimationController2D : MonoBehaviour {
    ...
    public bool getTransition() { return this.GetComponent<Animator>().IsInTransition(0); }
    ...
    public bool getEndOfAnim(string anim) {
        return _animator.GetCurrentAnimatorStateInfo(0).IsName(anim);       
    }
